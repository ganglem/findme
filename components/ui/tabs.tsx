...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-none bg-transparent py-10 text-muted-foreground",
      className
    )}
    {...props}
  />
